...
class MainActivity : AppCompatActivity(), ShopItemFragment.OnFragmentEditingFinishedListener {
    ...
    override fun onFragmentEditingFinished() {
    ...
    private fun setupSwipeListener(rvShopList: RecyclerView) {
        val callback = object : ItemTouchHelper.SimpleCallback(
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                val item = shlAdapter.currentList[viewHolder.adapterPosition]
    ...
    private fun setupClickListener() {
        shlAdapter.onShopItemClickListener = {
            if (isOneColumnMode()) {
    ...
    private fun setupLongClickListener() {
        shlAdapter.onShopItemLongClickListener = {
